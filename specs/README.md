...
|---|---|---|:---:|
| 📂 [`01_CORE_ENGINE_MASTER_SPEC.md`](01_CORE_ENGINE_MASTER_SPEC.md) | `SPEC-CORE-01` a `15`, `33`, `35`, `36`, `42`, `46` | DynamicSmartRouter, RAG Vectorial Qdrant, Multi-Tenant Isolation, Telemetría CMMI Nivel 4 y Backend Go i18n. | ✅ `CONSOLIDATED` |
