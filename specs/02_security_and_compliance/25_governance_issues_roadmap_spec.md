...
| **`#8`** | `[FEAT] Pasarela de Pago Integrada Stripe / MercadoPago en Customer Portal` | `feature`, `needs-spec`, `frontend-customer` | `OPEN` | [Issue #8](https://github.com/onlyone-ai-pods/aipods-docs/issues/8) |
