...
| **`#3`** | `[FEAT] Pipeline de CI/CD Automático en GitHub Actions con Docker y Helm` | `feature`, `spec-approved`, `devops` | `CLOSED` | [Issue #3](https://github.com/onlyone-ai-pods/aipods-docs/issues/3) |
...
| **`#5`** | `[FEAT] POD_CORE_NOTIFICATIONS_TELEGRAM: Alertas Push de Cobro y Seguridad` | `feature`, `needs-spec`, `pod-essential` | `OPEN (Postergado EvoCRM)` | [Issue #5](https://github.com/onlyone-ai-pods/aipods-docs/issues/5) |
...
| **`#13`** | `[FEAT] Motor de Resiliencia Enterprise (2FA OTP Interruption, NATS JobId, Saga Pattern & Policy Rulesets)` | `feature`, `spec-approved`, `pod-core` | `CLOSED` | [Issue #13](https://github.com/onlyone-ai-pods/aipods-docs/issues/13) |
