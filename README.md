...
1. 📜 **[`aipods-docs`](https://github.com/onlyone-ai-pods/aipods-docs)**: Especificaciones ejecutables SDD, Skills Kit Maestro, OpenAPI y Gobernanza.
2. 🌐 **[`aipods-core-engine`](https://github.com/onlyone-ai-pods/aipods-core-engine)**: Motor Backend en Go 1.22+, Swarm Protocol, Saga Pattern y Vector DB.
3. 🖥️ **[`aipods-frontend-customer`](https://github.com/onlyone-ai-pods/aipods-frontend-customer)**: Portal de Clientes React 18 / Vite (Puerto `3000`).
4. 🛡️ **[`aipods-frontend-admin`](https://github.com/onlyone-ai-pods/aipods-frontend-admin)**: Admin Review Hub & Senior Consultant Portal React 18 / Vite (Puerto `3001`).
...
Para ejecutar la suite completa de Quality & Security Gates en los 4 repositorios desde la raíz de `aipods-docs`:
...
Este proyecto y su documentación están protegidos bajo una **Licencia Propietaria del Autor**. Todos los derechos reservados © 2026 Martin Llanos. Ver el archivo [`LICENSE`](LICENSE) para más detalles.
